...
//
//                } else {
//                    if (theModel.checkJail(currentPlayer) == true && currentPlayer.getRollCount() == 0) {
...
//                    } else if (theModel.checkJail(currentPlayer) == true && currentPlayer.getRollCount() == 1) {
//                        theModel.rollDie(currentPlayer);
//                    } else if (theModel.checkJail(currentPlayer) == true && currentPlayer.getRollCount() == 2) {
